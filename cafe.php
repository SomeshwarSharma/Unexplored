          ...
          <div class="container">
            ...
            <nav class="main-nav" role="navigation">
              <ul class="main-menu">
                ...
                <li><a href="#section3">Google Map</a></li>
...
<!--                <li><a href="#section4">Comments</a></li>-->
      ...
      <div class="row">
        <div class="col-md-12" align="right">
            ...
            if (!$loggedIn)
                echo '
                        <button class="btn btn-submit" data-toggle="modal" data-target="#registerModal">Register</button>
                        <button class="btn btn-submit" data-toggle="modal" data-target="#logInModal">Log In</button>
                ';
            else
                echo '
      ...
      <section class="section my-services" data-section="section2">
		...
		<?php 
	$sql = "select * from menu WHERE P_id=$P_id";
	$result = $conn->query($sql);
      ...
      <section class="section about-services" data-section="section4">
          <div class="container">
          <div class="section-heading">
            <h2>Reviews</h2>
            <div class="line-dec"></div>
