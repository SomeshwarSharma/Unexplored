...
<html lang="en">
  ...
  <body>
                ...
                <div class="card-body">
                    <form method='POST' enctype="multipart/form-data">
                        <div class="input-group">
                            <input type="text" placeholder="Eatries Name" name='name'>
                        </div>
                        <div class="input-group">
                            <textarea placeholder="About Eatries" name='about' cols="70" rows="2"></textarea>
                        </div>
    ...
    <style>
    .card-2 .card-heading {
  background: url("assets/img/bg-heading-02.jpg") top left/cover no-repeat;
  width: 29.1%;
  display: table-cell;
}
