    ...
    <div id="page-wraper">
          ...
          <div class="container">
            ...
            <nav class="main-nav" role="navigation">
              <ul class="main-menu">
                ...
                <li><a href="review_places.php">REVIEW PLACES</a></li>
                <li><a href="#section1">REVIEW EATERIES</a></li>
              </ul>
            </nav>
          </div>
        </div>
      ...
      <div class="section-heading">
        ...
        <table class ="table table-striped table-hover table-bordered" >
            ...
            <?php
                $select = "select *  from post where  (P_type='ueeatries' OR  P_type='exeatries') AND P_show = 'no' ORDER BY p_id DESC";
                $result = mysqli_query($conn, $select);
                 ...
                 { ?>
                    <tr>
                        ...
                        <td> <button class="btn"> <a href="addmenu.php<?php $_SESSION['postid'] = $row['P_id'];?>" class="text-white"> Edit Menu </a>  </button> </td>
        ...
        <table class ="table table-striped table-hover table-bordered" >
            ...
            <?php
                $select = "select *  from post where   (P_type = 'ueeatries' OR P_type = 'exeatries') AND P_show = 'yes' ORDER BY p_id DESC";
                $result = mysqli_query($conn, $select);
                 while($row = mysqli_fetch_array($result)) 
                 { ?>
                    <tr>
